...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to logic.exe ("We", "Us", "Our").
...
- **Website** refers to logic.exe, accessible from [https://logic.exe.vercel.app](https://logic.exe.vercel.app)
